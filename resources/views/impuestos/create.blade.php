        ...
        <form method="POST" action="{{ route('impuestos.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo" value="{{ old('codigo') }}" required placeholder="Ej: IVA19, EXENTO" class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500 uppercase font-mono">
                ...
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}" required placeholder="Ej: IVA General 19%" class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="porcentaje" value="{{ old('porcentaje', '0.00') }}" required class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500 font-extrabold text-indigo-600">
            ...
            <div>
                <label class="block text-xs font-bold text-slate-600 uppercase mb-1">Descripción / Norma de Referencia</label>
                <textarea name="descripcion" rows="2" placeholder="Opcional. Ej: Art. 468 del Estatuto Tributario" class="w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500">{{ old('descripcion') }}</textarea>
            </div>
