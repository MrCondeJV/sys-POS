    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-4">
        <form method="GET" action="{{ route('lotes.index') }}" class="flex flex-wrap gap-3 items-center">
            <div class="relative flex-1 min-w-[220px]">
                ...
                <input type="text" name="q" value="{{ request('q') }}" placeholder="Buscar por número de lote o medicamento..." class="w-full pl-10 pr-3 py-2 rounded-xl border-slate-200 text-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
