...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <div class="flex items-center space-x-2 text-xs font-semibold text-slate-500 mb-1">
                ...
                <span>/</span>
                <span class="text-slate-800">Nuevo Cliente</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Registrar Nuevo Cliente</h1>
            <p class="text-sm text-slate-500">Completa los datos tributarios, contacto y parámetros crediticios del cliente.</p>
        </div>
        <div>
    ...
    <form action="{{ route('clientes.store') }}" method="POST"
          x-data="{
              tipoPersona: '{{ old('tipo_persona', 'NATURAL') }}',
              tipoDoc: '{{ old('tipo_documento', 'CC') }}',
              cupoCredito: '{{ old('cupo_credito', 0) }}',
              plazoDias: '{{ old('plazo_dias', 0) }}',
              onTipoPersonaChange() {
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="numero_documento" name="numero_documento" value="{{ old('numero_documento') }}" required
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                ...
                <div>
                    ...
                    <input type="text" id="nombre_comercial" name="nombre_comercial" value="{{ old('nombre_comercial') }}"
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="sm:col-span-1">
                    ...
                    <input type="text" id="departamento" name="departamento" value="{{ old('departamento', 'Sucre') }}"
                ...
                <div class="sm:col-span-1">
                    ...
                    <input type="text" id="ciudad" name="ciudad" value="{{ old('ciudad', 'Coveñas') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" id="cupo_credito" name="cupo_credito" value="{{ old('cupo_credito', 0) }}"
                ...
                <div>
                    ...
                    <input type="number" min="0" max="365" id="plazo_dias" name="plazo_dias" value="{{ old('plazo_dias', 0) }}"
                ...
                <div>
                    ...
                    <select id="estado" name="estado"
                        class="block w-full py-2.5 px-3 border border-slate-300 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                        <option value="ACTIVO" @selected(old('estado', 'ACTIVO') === 'ACTIVO')>Activo (Habilitado)</option>
                        <option value="INACTIVO" @selected(old('estado') === 'INACTIVO')>Inactivo (Bloqueado)</option>
                    </select>
                    @error('estado')
                        <p class="text-xs text-rose-600 mt-1 font-semibold">{{ $message }}</p>
                    @enderror
