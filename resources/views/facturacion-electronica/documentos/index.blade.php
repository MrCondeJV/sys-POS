        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-4">
                <form method="GET" action="{{ route('facturacion-electronica.index') }}" class="flex flex-wrap gap-3 items-center">
                    <input type="text" name="q" value="{{ request('q') }}" placeholder="Buscar por consecutivo o CUFE..." class="rounded-xl border-slate-200 text-sm focus:ring-indigo-500 focus:border-indigo-500 flex-1 min-w-[200px]">
